...
class MyAppFrame(template_frame.MainFrame):
    def __init__(self, parent):
        ...
        self.FoodSearch_button.SetBitmap(
            wx.Bitmap(u"../WORKING_HERE_Milestone2_Group62/gui_bitmaps/search.bmp", wx.BITMAP_TYPE_ANY))
        ...
        self.NutrientBreakdown_button.SetBitmap(
            wx.Bitmap(u"../WORKING_HERE_Milestone2_Group62/gui_bitmaps/pie-chart.bmp", wx.BITMAP_TYPE_ANY))
        ...
        self.NutritionRangeFilter_button.SetBitmap(
            wx.Bitmap(u"../WORKING_HERE_Milestone2_Group62/gui_bitmaps/arrow-down-up.bmp", wx.BITMAP_TYPE_ANY))
        ...
        self.NutritionalLevelFilter_button.SetBitmap(
            wx.Bitmap(u"../WORKING_HERE_Milestone2_Group62/gui_bitmaps/alt.bmp", wx.BITMAP_TYPE_ANY))
        ...
        self.NutritionalDensityVisualizer_button.SetBitmap(
            wx.Bitmap(u"../WORKING_HERE_Milestone2_Group62/gui_bitmaps/bar-chart-line.bmp", wx.BITMAP_TYPE_ANY))
...
class FoodSearchDialog(template_frame.FoodSearch_Dialog):
    ...
    def on_search_click(self, event):
        search_term = self.m_textCtrl1.GetValue().lower()  # search term from the text box
        if search_term:
